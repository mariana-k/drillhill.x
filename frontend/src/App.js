...
import { Home, Ecommerce, Orders, Calendar, Employees, Stacked, Pyramid, Customers, Kanban, Line, Area, Bar, Pie, Financial, ColorPicker, ColorMapping, Editor, DrillsList, DrillDetail } from './pages';
import { useStateContext } from './contexts/ContextProvider';

import './App.css';

const App = () => {
    const { setCurrentColor, setCurrentMode, currentMode, activeMenu, currentColor, themeSettings, setThemeSettings, isAuthorized, setDrillData } = useStateContext();
                    ...
                    >
                        ...
                        <div>
                            ...
                            <Routes>
                                ...
                                {/* drill detail */}
                                <Route path="/drill-detail" element={(<DrillDetail />)} />
